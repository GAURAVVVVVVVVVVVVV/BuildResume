  ...
  return (
    <div>
      <DashboardLayout>
            ...
            <div className={styles.headerWrapper}>
                <div>
                    ...
                    <p className={styles.headerSubtitle}>
                        {allResumes.length>0 ? `You have ${allResumes.length} resumes ${allResumes.length!==1?'':''}`:'Start building your professional resume'}
                    </p>
                </div>
        ...
        <Modal isOpen={showDeleteConfirm} onClick={()=>setShowDeleteConfirm(false)} title='Confirm Deletion' showActionBtn actionBtnText='Delete' actionBtnClassname='bg-red-600 hover:bg-red-700' onActionClick={handleDeleteResume}>
          <div className='p-4'>
            <div className='flex flex-col items-center text-center'>
              ...
              <p className={styles.deleteText}>
                Are youe aure you want to delete this resume? This action cannot be undone.
              </p>
            </div>
          </div>
        </Modal>
